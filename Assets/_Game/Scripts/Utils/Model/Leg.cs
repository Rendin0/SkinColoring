...
public class Leg
{
    ...
    public List<Texture> SetTexture(Texture2D texture, int xOffset = 0, int yOffset = 0, bool isLeft = false)
    {
        ...
        _left.material.mainTexture = texture.CutTexture(0 + xOffset, 32 + yOffset, 4, 12);
        _front.material.mainTexture = texture.CutTexture(4 + xOffset, 32 + yOffset, 4, 12);
        _right.material.mainTexture = texture.CutTexture(8 + xOffset, 32 + yOffset, 4, 12);
        _back.material.mainTexture = texture.CutTexture(12 + xOffset, 32 + yOffset, 4, 12);
