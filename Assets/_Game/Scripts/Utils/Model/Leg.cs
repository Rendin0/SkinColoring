...
public class Leg
{
    ...
    {
        _top.material.mainTexture = texture.CutTexture(4, 44, 4, 4);
        _bottom.material.mainTexture = texture.CutTexture(8, 44, 4, 4);

        _sides[0].sharedMaterial.mainTexture = texture.CutTexture(4, 32, 4, 12);
